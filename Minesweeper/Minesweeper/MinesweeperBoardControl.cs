...
namespace Minesweeper
{
    public partial class MinesweeperBoardControl : UserControl
    {
        ...
        public MinesweeperBoardControl()
        {
            ...
            for( int r = 0; r < Rows; r++ )
            {
                for( int c = 0; c < Columns; c++ )
                {
                    ...
                    cell.Updated += MinesweeperCell_Updated;
                    _cells[ r, c ] = cell;
                }
            }
        }
        ...
        {
            _bombs = Math.Min( bombs, Rows * Columns );
            Random r = new Random();
            for( int i = 0; i < _bombs; i++ )
            {
                int row = r.Next( Rows );
                int col = r.Next( Columns );
                ...
                PerformActionOnNeighbors( delegate( MinesweeperCell cell )
                {
                    cell.NeighborBombs++;
                }, _cells[ row, col ] );
            }
        ...
        private void MinesweeperBoardControl_MouseUp( object sender, MouseEventArgs e )
        {
            if( _onDownCell != null )
            {
                ...
                if( cell == _onDownCell )
                {
                    ...
                    {
                        _onDownCell.Flagged = !_onDownCell.Flagged;
                    }
                }
                else
                {
        ...
        private void MinesweeperCell_Updated( object sender, EventArgs e )
        {
